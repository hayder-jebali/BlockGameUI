...
export class WecoinService {
  ...
  private wecoinContractAddress = "0x50dc6320981d56aeda683f53f57e7517c8901dd1";
  private contract;

  constructor() { 
    if(this.isConnectedToBlockchain()){
      this.contract = web3.eth.contract(this.abiContract).at(this.wecoinContractAddress);
    }
  }
  ...
  getBalance(callback){
    this.contract.balanceOf(this.getAccount(), function(err, result){
      callback(result.c[0]);
    });
  }
